...
results_dir_healthy = os.path.join(
    ...
    "truncated_sequential_npe_network_baseline_conductance_based_01_baseline_replicate_01_nan_zero.pickle")
...
for results_dir in [results_dir_healthy, results_dir_interictal]:
    ...
    if "baseline" in results_dir:
        condition = "baseline"
    elif "hyperexcitability" in results_dir:
        condition = "hyperexcitability"
