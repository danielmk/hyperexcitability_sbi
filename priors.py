...
baseline_pattern_separation = {
    'low': {
        ...
        'membrane_sigma': 0.0 *mV,
        
        'voltage_sigma': 0.0 * mV
    ...
    'high': {
        ...
        'membrane_sigma': 10.0 * mV,
        'voltage_sigma': 10.0 * mV
    ...
    'constants': {
        ...
        'ain_ain_U_SE': 0.03,
        'ain_ain_tau_facil': 530 * ms,
        'inp_rate_profile_frequency': 10,
        'inp_rate_profile_amplitude': 100,
        'inp_refractory_period': 0.001,
        'n_repetitions': 5,
        }
    }
...
test_prior(baseline_pattern_separation)
